...
export default function EditClientPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.passportExpiry) updateData.passportExpiry = formData.passportExpiry;
      if (formData.preferences) updateData.preferences = formData.preferences;
      ...
      await client.patch(clientId).set(updateData).commit();
  ...
  const updateEmergencyContactField = (field: string, value: string) => {
    setFormData(prev => prev ? {
      ...prev,
  ...
  if (!formData) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-bold text-neutral-800">Client Not Found</h1>
        </div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="mb-6">
          ...
          <h1 className="text-4xl font-bold text-neutral-800">Edit Client</h1>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateEmergencyContactField('name', e.target.value)}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                />
              </div>
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateEmergencyContactField('relationship', e.target.value)}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateEmergencyContactField('phone', e.target.value)}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary focus:border-transparent"
                />
              </div>
            </div>
